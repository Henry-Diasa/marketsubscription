 ...
 * @LastEditTime: 2025-05-20 11:15:52
 * @FilePath: /AnniversaryProject/app/components/LarkLoginButton.tsx
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 */
import React, { useEffect } from 'react';

const LarkLoginButton = () => {

  useEffect(() => {
    const appId = 'cli_a77e6267f1b8902e';
    const redirectUri = 'http://54.238.193.37:4005/';
    
    window.location.href = `https://open.larksuite.com/open-apis/authen/v1/index?redirect_uri=${redirectUri}&app_id=${appId}&state=${true}`;
  }, []);
  return (
    <div style={{
      position: 'fixed',
